...
3. Gracz2: `/wymianaakceptuj`
4. Sprawdź czy otwiera się GUI handlu

### 3. Test funkcjonalności
1. Przeciągnij przedmioty ze swojego ekwipunku do slotów handlu
2. Kliknij przycisk "Gotowy" (czerwony/zielony blok)
3. Gdy obaj gracze są gotowi, kliknij "Potwierdź handel"
4. Sprawdź czy przedmioty zostały wymienione
...
- `/wymianaakceptuj` - zaakceptuj handel
- `/wymianaodrzuc` - odrzuć handel
